ggit add gigimport 'package:flutter/material.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                _buildModeCard(
                  ...
                  () {
                    developer.log('Navigating to Learn Fractions 2 mode');
                    Navigator.pushNamed(context, '/fractions_2_learn').then((_) {
                      developer.log('Returned from Learn Fractions 2 mode');
                    });
                  },
                ),
                ...
                _buildModeCard(
                  ...
                  () {
                    ...
                    Navigator.pushNamed(context, '/fractions_2_game').then((_) {

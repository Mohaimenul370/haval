            ...
            child: Column(
              ...
              children: [
                ...
                _buildModeCard(
                  ...
                  () {
                    developer.log('Navigating to Learn Time mode');
                    Navigator.pushNamed(context, '/time_learn').then((_) {
                      developer.log('Returned from Learn Time mode');
                    });
                  },
                ),
                ...
                _buildModeCard(
                  ...
                  () {
                    ...
                    Navigator.pushNamed(context, '/time_game').then((_) {

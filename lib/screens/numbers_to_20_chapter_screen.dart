...
class NumbersTo20ChapterScreen extends StatefulWidget {
  const NumbersTo20ChapterScreen({super.key});

  @override
  State<NumbersTo20ChapterScreen> createState() => _NumbersTo20ChapterScreenState();
}

class _NumbersTo20ChapterScreenState extends State<NumbersTo20ChapterScreen> {
  double? score;
  bool isLoading = true;
  ...
  Future<void> _loadScore() async {
    ...
    setState(() {
      score = SharedPreferenceService.getGamePercentage('numbers_to_20');
      isLoading = false;
    });
  }

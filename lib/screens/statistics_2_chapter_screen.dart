...
import 'statistics_2_screen.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              _buildModeCard(
                ...
                () {
                  developer.log('Navigating to Learn Statistics 2 mode');
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const Statistics2Screen(isGameMode: false),
                      fullscreenDialog: true,
                    ),
                  ).then((_) {
                    developer.log('Returned from Learn Statistics 2 mode');
                  });
                },
              ),
              ...
              _buildModeCard(
                ...
                () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const Statistics2Screen(isGameMode: true),
                      fullscreenDialog: true,
                    ),
                  ).then((_) {

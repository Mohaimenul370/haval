            ...
            child: Column(
              ...
              children: [
                ...
                _buildModeCard(
                  ...
                  () {
                    developer.log('Navigating to Learn Measures mode');
                    Navigator.pushNamed(context, '/measures_learn').then((_) {
                      developer.log('Returned from Learn Measures mode');
                    });
                  },
                ),
                ...
                _buildModeCard(
                  ...
                  () {
                    ...
                    Navigator.pushNamed(context, '/measures_game').then((_) {
